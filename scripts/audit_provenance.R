...
# Step 10 is opt-in and its outputs are cached by design: the sweep, the
# per-job cache it is rebuilt from, and the figure are all untouched by the
# default run.
outs <- outs[!grepl("weight_sensitivity|weight_jobs", outs, ignore.case = TRUE) &
